...
- `fc-core/src/mapper/basic/multicart.rs:1-1988`
  - 新增 Mapper 28 / 51 / 59 / 63 / 128 / 201 / 217 / 221 / 228 / 236 / 237 / 239 / 255 / 265 / 277 / 280 / 283 / 301 / 340 / 341 / 343。
  - 覆盖 Action 53 多寄存器 PRG/CHR/mirroring 模式、Mapper 51 低区 PRG-ROM window + mode latch、address latch PRG/CHR/mirroring、Mapper 63 越界 PRG open-bus 读、Mapper 128 outer address latch + inner bank、Mapper 221 双地址 latch/UNROM-NROM 模式/open-bus 高区读、Mapper 228 Action Enterprises 地址线 bank + nibble RAM、Mapper 236/237 reset DIP 与读路径、Mapper 239 地址 latch、Mapper 255 BMC 地址 latch、Mapper 265/277/280 的长尾 latch multicart 译码，以及 Mapper 283 的低区 PRG-ROM window + 高区 PRG32 latch。
- `fc-core/src/mapper/basic/longtail.rs:1-524`
  - 新增 Mapper 271 / 285 / 310 / 319 / 326。
  - 覆盖 FCEUmm 长尾 data-latch / K-1053 / BMC T-2291 / bootleg Contra-Gryzor 离散板：PRG32/PRG16/PRG8 译码、CHR8/CHR1 译码、CHR-RAM 写保护、reset DIP pad 读回、低区寄存器写、默认低区 PRG-RAM 禁用，以及 Mapper326 的 per-page CIRAM nametable page 映射。
- `fc-core/src/mapper/basic/ntdec.rs:95-282`
  - 新增 Mapper 298 / NTDEC UNL-TF1201。
  - 覆盖 8KB PRG bank、1KB CHR nibble register、mirroring、PRG swap、CPU-clock prescaled IRQ 和 reset 状态。当前主实现按 Mesen2/Nestopia 独立 TF1201 模型，FCEUmm 新版把 298 作为 VRC4 shortcut，作为参考差异记录。
...
| 298 | `basic/ntdec.rs:95-282; factory.rs:284; tests/behavior/asic.rs:102-130; capability.rs:221,464,715` | `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Ntdec/Tf1201.h` | 17-120 | Mapper 298 / TF1201：8KB PRG、1KB CHR nibble、PRG swap、mirroring、CPU-clock prescaler IRQ；当前实现主跟此独立 TF1201 模型 |
| 298 | `basic/ntdec.rs:95-282; factory.rs:284; tests/behavior/asic.rs:102-130; capability.rs:221,464,715` | `/Users/sunmeng/workspace/fc/nestopia/source/core/board/NstBoardUnlTf1201.cpp` | 50-190 | Nestopia TF1201 cross-check：write map、CHR nibble、PRG swap 与 IRQ enable/count 行为；IRQ 触发阈值与 Mesen2/FCEUX 存在细节差异，保留后续 ROM 证据精修 |
| 298 | `basic/ntdec.rs:95-282; factory.rs:284; tests/behavior/asic.rs:102-130; capability.rs:221,464,715` | `/Users/sunmeng/workspace/fc/fceux/src/boards/tf-1201.cpp` | 44-106 | FCEUX TF1201 独立实现：PRG/CHR/mirroring 写协议与 HBlank-ish IRQ；当前采用 CPU-prescaled IRQ 而非 scanline hook |
| 298 | `basic/ntdec.rs:95-282; factory.rs:284; tests/behavior/asic.rs:102-130; capability.rs:221,464,715` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/298.c` | 24-32 | FCEUmm 2025 参考差异：UNLTF1201 通过 VRC4 init shortcut 实现；本项目未直接采用此 shortcut |
| 321 | `mmc3/state.rs:118-120; mmc3/constructors.rs:426-430; mmc3.rs:679-686,813,1520-1523,1542,1920-1923; mmc3/tests.rs:848-872` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/321.c` | 26-56 | Mapper 321 / AX5202P-style MMC3 clone：低区 outer register、PRG32 forced mode、普通 MMC3 PRG/CHR outer OR、power/reset clear |
| 321 | `mmc3/state.rs:118-120; mmc3/constructors.rs:426-430; mmc3.rs:679-686,813,1520-1523,1542,1920-1923; mmc3/tests.rs:848-872` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/asic_mmc3.c` | 71-82 | AX5202P WRAM always-enabled / low write fall-through 行为 cross-check |
| 321 | `mmc3/state.rs:118-120; mmc3/constructors.rs:426-430; mmc3.rs:679-686,813,1520-1523,1542,1920-1923; mmc3/tests.rs:848-872` | `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/MapperFactory.cpp` | 574 | Mesen2 仅有 mapper 321 注释占位；记录为参考覆盖差异 |
| 334 | `mmc3/state.rs:121-124; mmc3/constructors.rs:433-437; mmc3.rs:686,814,1524-1529,1578-1600,1924-1928; mmc3/tests.rs:874-907` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/334.c` | 26-64 | Mapper 334 MMC3 clone：PRG32 latch、偶地址低区写、open-bus/DIP 读、reset DIP increment 与 MMC3 register reset |
| 334 | `mmc3/state.rs:121-124; mmc3/constructors.rs:433-437; mmc3.rs:686,814,1524-1529,1578-1600,1924-1928; mmc3/tests.rs:874-907` | `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/MapperFactory.cpp` | 586 | Mesen2 仅有 mapper 334 注释占位；记录为参考覆盖差异 |
| 273 | `vrc4.rs:16-20,30-36,83-91,130-180,204-272,407-459; factory.rs:281; tests/capability.rs:218,466,722; tests/behavior/asic.rs:236-264` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/273.c` | 37-83 | Mapper 273 / VRC2-derived board：复用 VRC2 PRG8/CHR1/mirroring，地址线为 `0x04/0x08`，`$F000-$FFFF` 自定义 CPU-cycle IRQ；本项目把 VRC IRQ 选择抽成 `VrcIrqKind`，并保留旧 `is_vrc4` 字段作为 save-state 兼容 fallback |
| 281 | `basic/jy.rs:61-220; factory.rs:280; tests/behavior/asic.rs:326-336; capability.rs:217,464,719` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/jyasic.c` | 514-527 | Mapper 281 / JY ASIC multicart：PRG AND `0x1F` OR `mode[3]<<5`，CHR/NT AND `0xFF` OR `mode[3]<<8`，允许 extended mirroring |
| 282 | `basic/jy.rs:61-220; factory.rs:281; tests/behavior/asic.rs:338-344; capability.rs:218,465,720` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/jyasic.c` | 529-550 | Mapper 282 / JY ASIC multicart：PRG AND `0x1F` OR `(mode[3]<<4)&~0x1F`，CHR/NT 按 `mode[3]&0x20` 切换 `0x1FF/0x0FF` mask |
| 295 | `basic/jy.rs:61-220; factory.rs:287; tests/behavior/asic.rs:346-355; capability.rs:224,471,726` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/jyasic.c` | 552-565 | Mapper 295 / JY ASIC multicart：PRG AND `0x0F` OR `mode[3]<<4`，CHR/NT AND `0x7F` OR `mode[3]<<7`，允许 extended mirroring |
| 288 | `ops.rs:12-18; dispatch.rs:158-164; cartridge.rs:475-490; basic/multicart.rs:405-445,476-479,742-752,767-776,830-837; factory.rs:284; tests/behavior/latch.rs:555-582; capability.rs:221,468,723` | `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/addrlatch.c` | 551-580 | Mapper 288 / GKCX1：地址锁存 PRG32=`latche>>3`、CHR8=`latche`、bit5 mirroring；读条件 `(latche&0x120)&&!(latche&0x10)` 时将 reset DIP OR 到 CPU 读地址线 |
| 288 | `ops.rs:12-18; dispatch.rs:158-164; cartridge.rs:475-490; basic/multicart.rs:405-445,476-479,742-752,767-776,830-837; factory.rs:284; tests/behavior/latch.rs:555-582; capability.rs:221,468,723` | `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Unlicensed/Gkcx1.h` | 5-21 | Mesen2 GKCX1 cross-check：PRG page size 32KB、CHR page size 8KB、write address selects PRG `(addr>>3)&3` and CHR `addr&7`;未建模 DIP read |
...
- `Mapper265::write_register()` / `prg_index()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/265.c:27-52,61-64`，并 cross-check Mesen2 `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Unlicensed/T262.h:33-47` 与 Nestopia `/Users/sunmeng/workspace/fc/nestopia/source/core/board/NstBoardBmcT262.cpp:40-47,74-86`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1429-1497` 表达 BMC-T-262 address/data latch、bit13 地址锁、PRG16 fixed-high/same-bank 与 bank0 NROM32 兼容分支、CHR8 fixed 0 和 mirroring bit。
- `Mapper277::write_register()` / `prg_index()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/277.c:27-50,53-69`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1499-1564` 表达 latch data reset=`0x08`、bit5 写锁、bit3/bit0 PRG16 模式、CHR8 fixed 0，以及 bit3 清零时回退 header mirroring。
- `Mapper280::write_register()` / `prg_index()` / `chr_write()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/280.c:23-26,35-69,72-90`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1566-1659` 表达 latch address/data、reset mode toggle、submapper 1 bank source、mode 0/1 PRG16/PRG32 译码、mirroring 和 CHR-RAM write-protect gate。
- `Mapper283::write_register()` / `low_prg_index()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/283.c:31-52,58-63`，并 cross-check FCEUX `/Users/sunmeng/workspace/fc/fceux/src/boards/gs-2004.cpp:31-52,58-62`、Mesen2 `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Unlicensed/Gs2004.h:16-25` 与 Nestopia `/Users/sunmeng/workspace/fc/nestopia/source/core/board/NstBoardRcm.cpp:60-69,89-91`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1661-1732` 表达 `$6000-$7FFF` 低区 PRG-ROM window、PRG32 latch、CHR8 fixed 0 和 header mirroring。Reset 默认采用 FCEUX/Mesen2/Nestopia 的末尾 PRG32 行为；FCEUmm `reg=0` 旁有 FIXME，记录为参考差异。
- `Mapper293::write_register()` / `prg_index()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/293.c:32-84`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1734-1812` 表达 NewStar 12-in-1/76-in-1 双 register、`$8000-$9FFF` 同写、`$A000-$BFFF`/`$C000-$DFFF` 分写、UNROM/NROM128/NROM256 模式、CHR8 fixed 0 与 bit7 mirroring。
- `Mapper294::write_register()` / `write_expansion()` / `write_low_register()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/294.c:26-54`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1814-1878` 表达 inner low-3-bit 高区写、`$4020-$7FFF` outer bank 写窗口的 A8 gate、PRG16 fixed-high、CHR8 fixed 0 与 latch bit7 mirroring。
- `Tf1201::write_register()` / `cpu_clock()` 对应 Mesen2 `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Ntdec/Tf1201.h:17-120`、Nestopia `/Users/sunmeng/workspace/fc/nestopia/source/core/board/NstBoardUnlTf1201.cpp:50-190` 与 FCEUX `/Users/sunmeng/workspace/fc/fceux/src/boards/tf-1201.cpp:44-106`；本项目在 `fc-core/src/mapper/basic/ntdec.rs:95-282` 表达 TF1201 的 PRG8/CHR1 nibble/mirroring/PRG swap/CPU-prescaled IRQ。FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/298.c:24-32` 把 mapper 298 路由到 VRC4 shortcut，记录为参考差异而非当前主实现。
- `Mapper271::write_register()` / `prg_index()` / `chr_index()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/datalatch.c:441-450`；本项目在 `fc-core/src/mapper/basic/longtail.rs:5-44` 表达 data latch 的 PRG32、CHR8 和 bit5 mirroring。
- `Mapper285::write_register()` / `read_pad()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/285.c:26-78`；本项目在 `fc-core/src/mapper/basic/longtail.rs:46-172` 表达 submapper 0/1 PRG bank 公式、CHR8 fixed 0、四种 mirroring 选择与 reset DIP pad 读回。
- `Mapper310::write_register()` / `prg8_pages()` / `chr_write()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/310.c:34-88`；本项目在 `fc-core/src/mapper/basic/longtail.rs:174-250` 表达 `regData[A>>14&1]`、`regAddr=A&0xFF`、四种 PRG 模式、CHR8 bank 与 CHR-RAM writable gate。
- `Mapper319::write_low_register()` / `write_register()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/319.c:36-86`；本项目在 `fc-core/src/mapper/basic/longtail.rs:252-342` 表达低区 register、latch CHR mux、pad read、低区 PRG-RAM 禁用和 soft reset pad bit toggle。
- `Mapper326::write_register()` / `nametable_read()` / `nametable_write()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/326.c:37-95`；本项目在 `fc-core/src/mapper/basic/longtail.rs:344-417` 表达 PRG8/CHR1 register、高区固定末 PRG8，以及四个 nametable register 到 CIRAM page 的映射。
- `Mapper301::write_register()` / `write_expansion()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/301.c:24-58`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1881-1945` 按 `asic_latch` 语义保存 latch data、`$5000-$5FFF` outer register、reset half toggle、PRG16 fixed-high 与 bit2 mirroring。
- `Mapper340::write_register()` / `prg_index()` / `chr_write()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/340.c:24-50`；本项目在 `fc-core/src/mapper/basic/multicart.rs:1947-2024` 表达 address latch、NROM/UNROM mode、submapper 0/1 mirroring 差异，以及 NROM mode CHR-RAM 写保护。
- `Mapper341::write_register()` / `prg_index()` / `chr_index()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/341.c:24-39`；本项目在 `fc-core/src/mapper/basic/multicart.rs:2026-2079` 表达 address latch PRG32/CHR8、submapper 1 的 `A7..A4 == $A` latch trap 与 mirroring bit 差异。
- `Mapper343::write_register()` / `write_expansion()` / `reset()` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/343.c:24-52`；本项目在 `fc-core/src/mapper/basic/multicart.rs:2081-2134` 表达 latch data PRG32、`$5000-$5FFF` mirroring register、CHR8 fixed 0 和 reset clear。
- `Mmc3::new_258()` / `Mmc3OuterBank::Mapper258` 对应 FCEUX `/Users/sunmeng/workspace/fc/fceux/src/boards/158B.cpp:29-69` 与 Mesen2 `/Users/sunmeng/workspace/fc/Mesen2/Core/NES/Mappers/Mmc3Variants/Unl158B.h:10-66`；本项目在 `fc-core/src/mapper/mmc3/state.rs:118-120`、`constructors.rs:427-431`、`mmc3.rs:681-691,846,1716-1723,1805-1809,2004-2007` 表达 UNL-158B protection register、PRG16/PRG32 forced modes、`$5000-$5FFF` open-bus OR LUT 读、`addr&7==0` 写 latch 和标准 MMC3 reset。
- `Mmc3::new_266()` / `Mmc3OuterBank::Mapper266` 对应 FCEUX `/Users/sunmeng/workspace/fc/fceux/src/boards/F-15.cpp:20-61` 与 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/f-15.c:20-61`；本项目在 `fc-core/src/mapper/mmc3/state.rs:121-123`、`constructors.rs:434-438`、`mmc3.rs:36-37,909,947-951,693-699,847,1568-1572,2008-2012` 表达 BMC F-15 的 `$A001` PRG-RAM 控制位门控、`$6000-$7FFF` 低区写消费、`reg&0x0F` PRG16/PRG32 latch、CHR 继续走普通 MMC3 和标准 MMC3 reset。
- `Vrc4::new_273()` / `VrcIrqKind::Mapper273` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/273.c:37-83`；本项目在 `fc-core/src/mapper/vrc4.rs:16-20,30-36,83-91,130-180,204-272,407-459` 与 `factory.rs:281` 表达 VRC2 PRG/CHR/mirroring 复用、自定义 `$F000/$F008` IRQ 写协议、CPU-cycle prescaler/mask 相位和 `clocks_cpu()` 能力。旧存档兼容通过保留 `Vrc24Config::is_vrc4` 并对新增 `irq_kind` 使用 serde default 维持。
- `Mmc3::new_267()` / `Mmc3OuterBank::Mapper267` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/267.c:26-62`；本项目在 `fc-core/src/mapper/mmc3/state.rs:124-126`、`constructors.rs:441-445`、`mmc3.rs:700-702,848-850,1574-1578,2008-2012` 表达 JY-119 outer bank 公式、低区一次性锁存、bit7 锁定后继续消费写但不更新寄存器，以及标准 MMC3 reset。Mesen2 本地 mapper factory 无 267 专用实现。
- `Mmc3::new_291()` / `Mmc3OuterBank::Mapper291` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/291.c:24-59`；本项目在 `fc-core/src/mapper/mmc3/state.rs:127-129`、`constructors.rs:448-452`、`mmc3.rs:704-710,852,1580-1582,2008-2012` 表达 CHR bit8 扩展、普通 MMC3 PRG mode、bit5 PRG32 forced mode、低区寄存器写和标准 MMC3 reset。Mesen2 本地 mapper factory 无 291 专用实现。
- `Mmc3::new_321()` / `Mmc3OuterBank::Mapper321` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/321.c:26-56`，并用 `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/asic_mmc3.c:71-82` 确认 AX5202P WRAM always-enabled/fall-through 语义；本项目在 `fc-core/src/mapper/mmc3/state.rs:130-132`、`constructors.rs:455-459`、`mmc3.rs:712-717,853,1584-1586,1599,2014-2017` 表达 PRG32 forced mode、普通 MMC3 PRG/CHR outer OR、低区写 fall-through 与 reset。
- `Mmc3::new_334()` / `Mmc3OuterBank::Mapper334` 对应 FCEUmm `/Users/sunmeng/workspace/fc/libretro-fceumm/src/boards/334.c:26-64`；本项目在 `fc-core/src/mapper/mmc3/state.rs:133-136`、`constructors.rs:462-466`、`mmc3.rs:719,854,1588-1593,1644-1657,2018-2021` 表达 PRG32 latch、低区偶地址写、open-bus/DIP 读和 reset DIP increment。Mesen2 `MapperFactory.cpp:574,586` 仅保留 321/334 注释占位，无可复刻实现。

## 以后替换时的删除边界

- 先替换 `fc-core/src/mapper/basic/unlicensed.rs:1-884`。
- 同批替换 `fc-core/src/mapper/basic/latch/discrete.rs` 里 Mapper 29 / 36 / 72 / 79 / 92 / 99 / 122 的新增段、`fc-core/src/mapper/basic/latch/sachen.rs` 里 Sachen 133 / 137 / 141 / 146 / 148 / 149 / 150 / 243 的新增段、`fc-core/src/mapper/basic/core.rs` 里 ColorDreams/Mapper144 的扩展段、`fc-core/src/mapper/basic/taito.rs` 里 Mapper 80 / 207 / 82 的新增段、`fc-core/src/mapper/basic/longtail.rs` 里 Mapper 271 / 285 / 310 / 319 / 326 的新增段、`fc-core/src/mapper/basic/ntdec.rs` 里 TF1201 / Mapper 298 的新增段，以及 `fc-core/src/mapper/basic/multicart.rs` 里 Mapper 51 / 59 / 63 / 128 / 201 / 217 / 221 / 228 / 236 / 237 / 239 / 255 / 265 / 277 / 280 / 283 / 293 / 294 / 301 / 340 / 341 / 343 的新增段。
