...
macro_rules! dispatch {
    ($self:ident, $m:ident => $body:expr) => {
        match $self {
            ...
            Mapper::Mapper265($m) => $body,
            Mapper::Mapper271($m) => $body,
            Mapper::Mapper272($m) => $body,
            Mapper::Mapper277($m) => $body,
            Mapper::Mapper280($m) => $body,
            Mapper::Mapper283($m) => $body,
            Mapper::Mapper285($m) => $body,
            Mapper::Mapper293($m) => $body,
            Mapper::Mapper294($m) => $body,
            Mapper::Tf1201($m) => $body,
            Mapper::Mapper301($m) => $body,
            Mapper::Mapper310($m) => $body,
            Mapper::Mapper319($m) => $body,
            Mapper::Mapper326($m) => $body,
            Mapper::Mapper330($m) => $body,
            Mapper::Mapper340($m) => $body,
            Mapper::Mapper341($m) => $body,
            Mapper::Mapper343($m) => $body,
            Mapper::Mapper352($m) => $body,
